...
<!-- #042D6F -->
			...
			<div class="collapse navbar-collapse" id="navbarColor01">
				<ul class="navbar-nav me-auto">
					...
					<li class="nav-item"><a class="nav-link active" href="store_rst.jsp">음식점</a></li>
...
%>
	...
	<div class=" bg-light p-3 ">
		<form method="get" action="./store_rst.jsp" class="row mx-5 px-5">
			<div class="col-md-2">
			...
			<div class="col-md-2">
				...
				<option value="한식" <%if(detailKind.equals("한식"))out.println("selected"); %>>한식</option>
				<option value="양식" <%if(detailKind.equals("양식"))out.println("selected"); %>>양식</option>
				<option value="중식" <%if(detailKind.equals("중식"))out.println("selected"); %>>중식</option>
				<option value="일식" <%if(detailKind.equals("일식"))out.println("selected"); %>>일식</option>
				</select>
			</div>
			<div class="col-md-6">
