...
<!-- *******메뉴바********* -->
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top">
		<div class="container-fluid">
			<a class="navbar-brand" href="welcome_login.jsp">
...
<!-- *********게시판 내용************* -->
	<div class="container">
		...
		<div class="row">	
			<form method="post" action="board_updateAction.jsp?bID=<%=bID%>">
				<table class="table board_write">
					<tbody>
						<tr class="title">
							<td class="text"><strong>제목</strong></td>
		        			<td><input type="text" class="form-control" placeholder="제목 입력" name="bTitle" maxlength="50" value="<%=board.getbTitle()%>"></td>
						</tr>
						<tr class="cont">
							<td colspan="2">
								<textarea placeholder="내용 입력" name="bContent" maxlength="2048"><%=board.getbContent()%></textarea>
							</td>
						</tr>
					</tbody>
				</table>
				...
				<div class="bt_wrap">
		           	<input type="submit" class="btn btn-primary mx-1" value="수정">           	            	           
		        </div>														
			</form>		
		</div>
	</div>
